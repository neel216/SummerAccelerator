...
def get_SAT_scores():
    SATscores = open("./data/2010_SAT__College_Board__School_Level_Results.csv", "r")
...
def get_AP_tests():
    APtests = open("./data/2010__AP__College_Board__School_Level_Results.csv", "r")
...
def get_graduation_rates():
    Graduation = open("./data/2005-2010_Graduation_Outcomes_-_School_Level.csv", "r")
